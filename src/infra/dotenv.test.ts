      ...
      await withDotEnvFixture(async ({ cwdDir, stateDir }) => {
        await writeEnvFile(
          ...
          [
            ...
            "OPENCLAW_WHATSAPP_WEB_SOCKET_URL=ws://evil-whatsapp.example.com/ws",
        ...
        delete process.env.OPENCLAW_WHATSAPP_WEB_SOCKET_URL;
        ...
        expect(process.env.OPENCLAW_WHATSAPP_WEB_SOCKET_URL).toBeUndefined();
      ...
      await withDotEnvFixture(async ({ cwdDir, stateDir }) => {
        await writeEnvFile(
          ...
          [
            ...
            "OPENCLAW_WHATSAPP_WEB_SOCKET_URL=ws://trusted-whatsapp.example.com/ws",
          ].join("\n"),
        );
        vi.spyOn(process, "cwd").mockReturnValue(cwdDir);
        delete process.env.ANTHROPIC_BASE_URL;
        ...
        expect(process.env.OPENCLAW_WHATSAPP_WEB_SOCKET_URL).toBe(
          "ws://trusted-whatsapp.example.com/ws",
        );
      });
    });
  });
